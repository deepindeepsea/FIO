...
MultEvent cpu df --ini /root/RS/DF/df_stones_multevent_files_v4/df_rs_all.ini -s 0 \
        core --ini /root/RS/PS_DG/ps_core_all.ini -s 3 \
	...
	iohc --ini /root/RS/NBIO/RS_NBIO_IOHC_all.ini \
        umc --ini /root/RS/UMC/RS_umc_v1.ini -s 0-11 -A "numactl -m 1 ./fio_nvme_scaled_auto.sh 8 seqread 1 gen5" -O $1 report -f 5 -R
